...
/************************ META BOXES *************************/
    ...
    #CUSTOM LINK
    add_action( 'add_meta_boxes', 'imt_custom_href' );
    function imt_custom_href(){
    	add_meta_box('postcustomhref',
    			__( 'Select Target Link', 'imt'),
	    			'imtCustomHrefMetaBox',
	    			IMT_POST_TYPE,
	    			'normal',
	    			'high' );
    }    
...
class IndeedMyTeamWidget extends WP_Widget {
  ...
  () {
    ...
    'indeed_product_carousel', 

    // Widget name will appear in UI
    __('Indeed My Team', 'edsbootstrap'), 

    // Widget description
    array( 'description' => __( 'Indeed My Team', 'edsbootstrap', 'edsbootstrap' ), ) 
    );
	}
