...
function xoo_qv_enqueue_scripts(){
	...
	wp_enqueue_style('xoo-qv-style',get_theme_file_uri('/vendor/quick-view-woocommerce/assets/css/xoo-qv-style.css',__FILE__),null,'1.7');
	wp_enqueue_script('xoo-qv-js',get_theme_file_uri('/vendor/quick-view-woocommerce/assets/js/xoo-qv-js.js',__FILE__),array('jquery'),'1.7',true);
...
function xoo_qv_product_image(){
	include( get_template_directory() . '/vendor/quick-view-woocommerce/templates/xoo-qv-product-image.php');
}
...
if($xoo_qv_lb_en_gallery_value){
	function xoo_qv_product_thumbnails(){
		include(get_template_directory() . '/vendor/quick-view-woocommerce/templates/xoo-qv-product-thumbnails.php');
	}
...
function xoo_qv_button(){
	...
	$html .= esc_attr($xoo_qv_button_text_value);
	$html .= '</a>';
	echo $html;
}
...
require_once get_template_directory() . '/vendor/quick-view-woocommerce/templates/xoo-qv-ajax.php';
