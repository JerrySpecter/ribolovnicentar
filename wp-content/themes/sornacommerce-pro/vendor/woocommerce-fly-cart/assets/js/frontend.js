jQuery( document ).ready( function() {
	...
	jQuery( 'body' ).on( 'click', '#woosmc-area .woosmc-item-qty-minus', function() {
		var qtyMin = 1;
		var step = 1;
		var qtyInput = jQuery( this ).parent().find( '.woosmc-item-qty-input' );
	...
	// Qty on change
	jQuery( 'body' ).on( 'change', '#woosmc-area .woosmc-item-qty-input', function() {
	...
	// Qty validate
	var t = false;
	jQuery( 'body' ).on( 'focus', '#woosmc-area .woosmc-item-qty-input', function() {
	...
	jQuery( 'body' ).on( 'blur', '#woosmc-area .woosmc-item-qty-input', function() {
		if ( t != false ) {
	...
	// Count button
	jQuery( 'body' ).on( 'click', '#woosmc-count,.single_add_to_cart_flyer', function() {
		woosmc_show_cart();
	} );
...
function woosmc_perfect_scrollbar() {
	jQuery( '#woosmc-area .woosmc-area-top' ).perfectScrollbar( {suppressScrollX: true, theme: 'woosmc'} );
}
