...
defined( 'ED_LOGO_PATH' )    or  define( 'ED_LOGO_PATH',    get_template_directory().'/vendor/unlimited-logo-carousel/' );
defined( 'ED_LOGO_URL' )    or  define( 'ED_LOGO_URL',    get_template_directory_uri().'/vendor/unlimited-logo-carousel/' );
...
function activate_ed_logo() {
	require_once get_template_directory().'/vendor/unlimited-logo-carousel/' . '/inc/activator.php';
...
function deactivate_ed_logo() {
	require_once get_template_directory().'/vendor/unlimited-logo-carousel/'. '/inc/deactivator.php';
	Unlimited_Logo_Deactivator::deactivate();
}
add_action( 'after_setup_theme', 'activate_ed_logo' );
