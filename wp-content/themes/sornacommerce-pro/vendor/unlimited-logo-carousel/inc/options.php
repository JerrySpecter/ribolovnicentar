...
function ed_logo_carousel_options_do() {
		...
		<div class="postbox-container" style="width: 49%;margin-right: 10px;">
			<div id="normal-sortables" class="meta-box-sortables ui-sortable">
				<div class="postbox" id="ed-global-settings">
					...
					<div class="inside">
                        <table class="form-table ed-table-options">
                          <tr>
                            <th style="width:30%"><label for="sample_text"><?php _e( 'Auto Play', 'ed_logo' ); ?></label>
                           </th>
                          <td>
                            <select name="ed_logo_carousel_options[auto_play]">
                          ...
                          <td>
                            <input id="ed_logo_carousel_options[auto_play_speed]" name="ed_logo_carousel_options[auto_play_speed]" value="<?php echo $options['auto_play_speed'];?>" type="number"><span style="font-size:12px; margin-left:25px; font-style:italic; color:#aaa;">milliseconds</span>
                          </td>
                          </tr>
                            <tr>
                          ...
                          <td>
                            <input id="ed_logo_carousel_options[slide_speed]" name="ed_logo_carousel_options[slide_speed]" value="<?php echo $options['slide_speed'];?>" type="number"><span style="font-size:12px; margin-left:25px; font-style:italic; color:#aaa;">milliseconds</span>
                          </td>
                          </tr>
                          ...
                          <td>
                            <select name="ed_logo_carousel_options[stop_on_hover]" >
                          ...
                          <td>
                            <select name="ed_logo_carousel_options[next_prev_position]">
                         ...
                         <tr>
                          ...
                          <td>
                            <select name="ed_logo_carousel_options[pagination]">
                         ...
                         <tr>
                          ...
                          <td>
                            <select name="ed_logo_carousel_options[mouse_drag]">
                          ...
                          <td>
                            <select name="ed_logo_carousel_options[lazy_load]">
                          ...
                          <td>
                            <input id="ed_logo_carousel_options[desktop]" name="ed_logo_carousel_options[desktop]" value="<?php echo $options['desktop'];?>" type="number">
                          </td>
                          </tr>
                          ...
                          <td>
                            <input id="ed_logo_carousel_options[mini_desktop]" name="ed_logo_carousel_options[mini_desktop]" value="<?php echo $options['mini_desktop'];?>" type="number">
                          </td>
                          </tr>
                          ...
                          <td>
                            <input id="ed_logo_carousel_options[tablet]" name="ed_logo_carousel_options[tablet]" value="<?php echo $options['tablet'];?>" type="number">
                          </td>
                          </tr>
                          ...
                          <td>
                            <input id="ed_logo_carousel_options[mobile]" name="ed_logo_carousel_options[mobile]" value="<?php echo $options['mobile'];?>" type="number">
                          </td>
                          </tr>
				...
				<div class="postbox" id="ed-social-settings">
					...
					<div class="inside">
						<table class="form-table ed-table-options">
                          ...
                          <td>
                            <input type="text" name="ed_logo_carousel_options[arrows_size]" value="<?php echo $options['arrows_size'];?>" />px
                          </td>
                          </tr>
                          ...
                          <td>
                             <input class="ed_color_field" type="text" name="ed_logo_carousel_options[arrows_bg]" value="<?php echo $options['arrows_bg'];?>"/>
                          </td>
                          </tr>
                          ...
                          <td>
                             <input class="ed_color_field" type="text" name="ed_logo_carousel_options[arrows_color]" value="<?php echo $options['arrows_color'];?>"/>
                          </td>
                          </tr>
                          ...
                          <td>
                             <input class="ed_color_field" type="text" name="ed_logo_carousel_options[arrows_bg_h]" value="<?php echo $options['arrows_bg_h'];?>"/>
                          </td>
                          </tr>
                          ...
                          <td>
                             <input class="ed_color_field" type="text" name="ed_logo_carousel_options[arrows_color_h]" value="<?php echo $options['arrows_color_h'];?>"/>
                          </td>
                          </tr>
                          ...
                          <td>
                             <input class="ed_color_field" type="text" name="ed_logo_carousel_options[pagination_color]" value="<?php echo $options['pagination_color'];?>"/>
                          </td>
                          </tr>
                          ...
                          <td>
                             <input class="ed_color_field" type="text" name="ed_logo_carousel_options[pagination_color_h]" value="<?php echo $options['pagination_color_h'];?>"/>
                          </td>
                          </tr>
                          ...
                          <td>
                             <input class="ed_color_field" type="text" name="ed_logo_carousel_options[tooltip_bg]" value="<?php echo $options['tooltip_bg'];?>"/>
                          </td>
                          </tr>
                          ...
                          <td>
                             <input class="ed_color_field" type="text" name="ed_logo_carousel_options[tooltip_color]" value="<?php echo $options['tooltip_color'];?>"/>
                          </td>
                          </tr>
                          ...
                          <td>
                            <select name="ed_logo_carousel_options[tooltip_size]" >
                    <?php for ($x = 9; $x <= 50; $x++) {?>
                  <option value="<?php echo $x;?>" <?php if($options['tooltip_size'] == $x):?> selected="selected"<?php endif;?>><?php echo $x;?> <?php _e( 'px', 'ed_logo' ); ?></option>
                   <?php } ?>
                          ...
                          <td>
    <select name="ed_logo_carousel_options[logo_border]" >
    ...
    <option value="yes" <?php if($options['logo_border'] == 'yes'):?> selected="selected"<?php endif;?>><?php _e( 'Yes', 'ed_logo' ); ?></option>	
                          ...
                          <td>
   							<input name="ed_logo_carousel_options[border_size]]" value="<?php echo $options['border_color'];?>" type="number"> px
                          </td>
                          </tr>
                          ...
                          <td>
                             <input class="ed_color_field" type="text" name="ed_logo_carousel_options[border_color]" value="<?php echo $options['border_color'];?>"/>
                          </td>
                          </tr>
                           <tr>
                            <th style="width:30%"><?php _e( 'Border Hover Color', 'ed_logo' ); ?></th>
                          <td>
                             <input class="ed_color_field" type="text" name="ed_logo_carousel_options[border_color_h]" value="<?php echo $options['border_color_h'];?>"/>
                          </td>
                          </tr>
