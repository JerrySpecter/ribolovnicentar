...
final class TA_WC_Variation_Swatches {
	...
	public function includes() {
		...
		require_once get_template_directory().'/vendor/variation-swatches-for-woocommerce/includes/class-admin.php';
		require_once get_template_directory().'/vendor/variation-swatches-for-woocommerce/includes/class-frontend.php';
	}
	...
	public function load_textdomain() {
		load_plugin_textdomain( 'wcvs', false, get_template_directory().'/vendor/variation-swatches-for-woocommerce/languages/' );
	}
...
add_action( 'after_setup_theme', 'ta_wc_variation_swatches_constructor' );
