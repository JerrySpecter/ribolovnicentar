...
class TA_WC_Variation_Swatches_Admin {
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_style( 'tawcvs-admin', get_template_directory_uri().'/vendor/variation-swatches-for-woocommerce/assets/css/admin.css', array( 'wp-color-picker' ), '20160615' );
		wp_enqueue_script( 'tawcvs-admin', get_template_directory_uri().'/vendor/variation-swatches-for-woocommerce/assets/js/admin.js', array( 'jquery', 'wp-color-picker', 'wp-util' ), '20170113', true );
