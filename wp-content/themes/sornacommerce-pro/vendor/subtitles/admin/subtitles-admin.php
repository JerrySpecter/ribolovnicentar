...
if ( ! class_exists( 'Subtitles_Admin' ) ) {
	...
	class Subtitles_Admin extends Subtitles {
		...
		public function subtitle_admin_scripts( $hook ) {
			 ...
			 * @since 1.0.0
			 */
			wp_enqueue_style( self::PLUGIN_SLUG . '-admin-style', get_theme_file_uri( '/vendor/subtitles/admin/assets/css/subtitles.css' ), array(), self::VERSION );
			 ...
			 * @since 1.0.0
			 */
			wp_enqueue_script( self::PLUGIN_SLUG . '-admin-scripts',get_theme_file_uri( '/vendor/subtitles/admin/assets/js/subtitles.js' ), array( 'jquery' ), self::VERSION, true );
