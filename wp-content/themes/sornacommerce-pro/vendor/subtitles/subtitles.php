 ...
 * @since 1.0.0
 */
require get_template_directory() . '/vendor/subtitles/public/class-subtitles.php';
 ...
 */
add_action(
	'after_setup_theme', // The hook on which Subtitles is fired.
	array(
 ...
 * @since 1.0.0
 */
require get_template_directory() . '/vendor/subtitles/public/includes/template-tags.php';
...
if ( is_admin() && ( ! defined( 'DOING_AJAX' ) || ! DOING_AJAX ) ) {
	require get_template_directory() . '/vendor/subtitles/admin/subtitles-admin.php';

	add_action(
		'after_setup_theme', // The hook on which Subtitles_Admin is fired.
		array(
