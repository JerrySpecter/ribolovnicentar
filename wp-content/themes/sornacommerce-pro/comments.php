...
<section class="section blog">
	...
	'fields' => apply_filters(
		'comment_form_default_fields', array(
			'author' =>'<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">' . '<input id="author" placeholder="' . esc_html__( 'Your Name', 'sornacommerce'  ) . '" name="author" type="text" value="' .
				esc_attr( $commenter['comment_author'] ) . '" size="30" />'.
				( $req ? '<span class="required">*</span>' : '' )  .
				'</div>'
				,
			'email'  => '<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">' . '<input id="email" placeholder="' . esc_html__( 'Your Email', 'sornacommerce'  ) . '" name="email" type="text" value="' . esc_attr(  $commenter['comment_author_email'] ) .
				'" size="30" />'  .
				( $req ? '<span class="required">*</span>' : '' ) 
				 .
				'</div>',
	 ...
	 'comment_field' =>  '<div class="col-md-12"><textarea id="comment" name="comment" cols="45" rows="8" aria-required="true"  placeholder="' . esc_html__( 'Comment', 'sornacommerce' ) . '">' .
    '</textarea></div>',
    'comment_notes_after' => '',
