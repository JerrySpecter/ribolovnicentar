 ...
 *
 * @uses sornacommerce_header_style()
 */
function sornacommerce_custom_header_setup() {
	add_theme_support( 'custom-header', apply_filters( 'sornacommerce_custom_header_args', array(
		...
		'height'                 => 250,
		'flex-height'            => true,
		'wp-head-callback'       => 'sornacommerce_header_style',
	) ) );
}
add_action( 'after_setup_theme', 'sornacommerce_custom_header_setup' );
